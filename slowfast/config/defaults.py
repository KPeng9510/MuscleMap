...
_C.TRAIN.CHECKPOINT_FILE_PATH =  "/path/to/checkpoint_rgb"
...
# Dataset for testing.
_C.TEST.DATASET = "MuscleMap"

# Total mini-batch size
_C.TEST.BATCH_SIZE = 8

# Path to the checkpoint to load the initial weight.
_C.TEST.CHECKPOINT_FILE_PATH = "path/to/checkpoint/test"
...
_C.MVIT.DECODER_NORM = "layernorm"
...
_C.MVIT.DECODER_POOL_KV_STRIDE_ADAPTIVE = None

# Stride size for the Pool Q at layer i.
# Format: [[i, stride_t_i, stride_h_i, stride_w_i], ...,]
_C.MVIT.POOL_Q_STRIDE = []
_C.MVIT.DECODER_POOL_Q_STRIDE = []
...
_C.MVIT.DECODER_POOL_KVQ_KERNEL = None
